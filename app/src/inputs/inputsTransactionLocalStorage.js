(function () {
    ...
    InputsTransactionLocalStorage.$inject = ['DepartmentsLocalStorage', 'ProjectsLocalStorage', 'EmployeesLocalStorage', 'GoodsLocalStorage'];

    function InputsTransactionLocalStorage(DepartmentsLocalStorage, ProjectsLocalStorage, EmployeesLocalStorage, GoodsLocalStorage) {
        return {
